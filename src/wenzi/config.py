...
def validate_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    rules = [
        ...
        ("audio.duck_system_audio", bool, None, DEFAULT_CONFIG["audio"]["duck_system_audio"]),
        ("audio.duck_volume_ratio", (int, float),
         lambda v: not isinstance(v, bool) and 0.0 <= v <= 1.0,
         DEFAULT_CONFIG["audio"]["duck_volume_ratio"]),
        ("audio.duck_max_volume", (int, float),
         lambda v: not isinstance(v, bool) and 0.0 <= v <= 1.0,
         DEFAULT_CONFIG["audio"]["duck_max_volume"]),
